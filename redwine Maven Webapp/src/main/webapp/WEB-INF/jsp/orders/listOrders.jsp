                                ...
                                <table class="table table-striped table-bordered table-hover datatable">
                                    ...
                                    <tbody>
                                    	<c:forEach var="orders" items="${orderList}">
                                        	<tr>
                                        		<td><fmt:formatDate value='${orders.order_time}' pattern='yyyy-MM-dd HH:mm:ss'/></td>
                                            	<td>${orders.total_price }</td>
                                            	<td>${orders.order_status.status_name }</td>
                                            	<td>${orders.user.username }</td>
                                            	
                                            
                                            	<td>
                                            		<a href="${pageContext.request.contextPath}/orders/listOrderItem?id=${orders.order_id}">查看详细</a>
                                            	</td>
                                        	</tr>
                                        </c:forEach>
                                    </tbody>
