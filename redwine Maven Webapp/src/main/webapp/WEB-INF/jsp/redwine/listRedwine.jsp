                ...
                <div class="row-fluid">
                    <div class="span12">
                         <div  class="daohanglink"style="">
                           ...
                           <span>></span>
                           <span>所有红酒信息</span>
                           <a href="${pageContext.request.contextPath}/redwine/addRedwineInput" class="label label-warning" style="float:right; margin:8px;">添加</a>
                         </div>
                        <div class="well brown">
                            ...
                            <div class="well-content" style="border:0px;">
                                <table class="table table-striped table-bordered table-hover datatable">
                                    ...
                                    <tbody>
                                    	<c:forEach var="redwine" items="${redwineList}">
                                        	<tr>
                                            	<td>${redwine.redwine_name }</td>
                                            	<td>${redwine.price}</td>
                                            	<td>${redwine.origin}</td>
                                            	<td>${redwine.vintage }</td>
                                            	<td>${redwine.alcohol }</td>
                                            	<td>${redwine.capacity }</td>
                                            	<td><fmt:formatDate value='${redwine.register_date}' pattern='yyyy-MM-dd HH:mm:ss'/></td>
                                            	<td>${redwine.sales }</td>
                                            	<td>${redwine.redwine_type.type_name }</td>
                                            	<td>
                                            	<a class="btn" href="${pageContext.request.contextPath}/redwine/showRedwine?id=${redwine.redwine_id}" title="查看"><i class="icon-inbox"></i></a>
                                            
                                            	<a class="btn" href="${pageContext.request.contextPath}/redwine/editRedwineInput?id=${redwine.redwine_id}" title="修改"><i class="icon-exclamation"></i></a>
                                            	</td>
                                        	</tr>
                                        </c:forEach>
                                    </tbody>
